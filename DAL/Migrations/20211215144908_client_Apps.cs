...
{
    public partial class client_Apps : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientApplications_Applications_Application",
                        column: x => x.Application,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientApplications_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientApplications_Application",
                table: "ClientApplications",
                column: "Application");

            migrationBuilder.CreateIndex(
                name: "IX_ClientApplications_UserId",
                table: "ClientApplications",
                column: "UserId");
        }
